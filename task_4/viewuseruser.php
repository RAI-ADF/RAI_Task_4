...
<div class="form">
      ...
      <ul class="tab-group">
        <li class="tab"><a href="forminput.html">Form Input</a></li>
        <li class="tab active"><a href="viewuseruser.php">View User</a></li>
      </ul>
	...
	$email = $_POST['femail'];
	$tampil = mysql_query("SELECT * FROM registrasi where email = '$email'   ORDER BY username");
