			...
			<style>
				.nav-pills > li > a{
					...
					<ul class="nav nav-pills nav-stacked nav-static"> <!--stacked untuk jadi vertical -->
						<li><a href="admin1.php">Lihat Data</a></li>
						<li class="active"><a>Atur Data Data</a></li>
					</ul>
		</div>
			...
			<div class="modal-body">
				...
				<div class="collapse navbar-collapse">
						...
						.glyphicon{
							...
							<div class="col-md-4 text-center"><li><a style="color: #c01515" href=""><p class="text-center"><div class="glyphicon glyphicon-pencil"></div><div class="glyphicon glyphicon-link"></div><br>Atur Data User</p></a></li></div>
