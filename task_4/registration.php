...
<head>
	...
	<link rel="stylesheet" href="assets/themes/base/jquery.ui.all.css">
...
<body onload="load_province()">
    ...
    <div id="container">
        ...
        <div id="container_body">
        <div>
            <h2 class="form_title">Silahkan Registrasi</h2>
        </div>
            <div id="form_name">
                <div class="firstnameorlastname">
                <form method="post" validate_form(); id="register_form">
                    <div id="email_form">
                        <input type="text" name="name" id="name" placeholder="Nama lengkap"  class="input_name" required >
                    </div>
                    <div id="password_form">
                        <input type="password" name="password" id="password" class="input_password" placeholder="Password" required>
                    </div>
                    <div id="password_form">
                        <input type="password" name="confirm_password" id="confirm_password" placeholder="Input ulang Password" class="input_password" required>
                    </div>
                    <div id="email_form">
                        <input type="email" name="email" id="email" class="input_email" placeholder="Input Email" required>
                    </div>
                    <div id="email_form">
                    ...
                    <div id="email_form">
                        <input type="date" id="datepicker" name="date_of_birth" required>
                    </div>
                    
                    <input id="sign_user" type="submit" name="btn-signup" value="Daftar">
                </form>
                </div>
            </div>
        </div>
