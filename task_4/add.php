...
$upFoto = isset($_POST['upFoto'])?$_POST['upFoto']:'';


if(isset($_POST['submit'])){
	$query="insert into tbl_data_pegawai values ('$nip_pegawai','$nama_pegawai','$jenis_kelamin','$tempat_lahir','$tanggal_lahir','$alamat','$upFoto') ";
	mysql_query($query);
	$query="insert into tbl_data_golongan values ('','$golongan','$tmt_golongan','$nip_pegawai') ";
	mysql_query($query);
	$query="insert into tbl_data_jabatan values ('','$jabatan','$tmt_jabatan','$tanggal_pengangkatan_cpns','$latihan_jabatan','$nip_pegawai') ";
	mysql_query($query);
	$query="insert into tbl_pendidikan values ('','$pendidikan_terakhir','$nama_sekolah','$fakultas','$jurusan','$tahun_lulus','$nip_pegawai') ";
	mysql_query($query);
	// echo $nip_pegawai.'<br>';
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal " method="post" role="form">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="nip_pegawai" name="nip_pegawai" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Nama Pegawai</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="nama_pegawai" name="nama_pegawai" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="tempat_lahir" name="tempat_lahir" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        ...
                                        <div class="col-md-4 col-xs-11">
											...
											<input type="text" readonly="" size="16" class="form-control" name="tanggal_lahir">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="alamat" name="alamat" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-md-4 col-xs-11">
											...
											<input type="text" readonly="" size="16" class="form-control" name="tmt_golongan">
                                              <span class="input-group-btn add-on">
                                                <button class="btn btn-primary" type="button"><i class="fa fa-calendar"></i></button>
                                              </span>
											</div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="jabatan" name="jabatan" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        ...
                                        <div class="col-md-4 col-xs-11">
											...
											<input type="text" readonly="" size="16" class="form-control" name="tmt_jabatan">
                                              <span class="input-group-btn add-on">
                                                <button class="btn btn-primary" type="button"><i class="fa fa-calendar"></i></button>
                                              </span>
											</div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-md-4 col-xs-11">
											...
											<input type="text" readonly="" size="16" class="form-control" name="tanggal_pengangkatan_cpns">
                                              <span class="input-group-btn add-on">
                                                <button class="btn btn-primary" type="button"><i class="fa fa-calendar"></i></button>
                                              </span>
											</div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="latihan_jabatan" name="latihan_jabatan" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Pendidikan Terakhir</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="pendidikan_terakhir" name="pendidikan_terakhir" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Nama Sekolah</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="nama_sekolah" name="nama_sekolah" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Fakultas</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="fakultas" name="fakultas" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Jurusan</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="jurusan" name="jurusan" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Tahun Lulus</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="tahun_lulus" name="tahun_lulus" type="text" required="required" />
                                        </div>
                                    </div>
									<div class="form-group ">
									...
									<div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <input value="Save"  name="submit" type="submit" class="btn btn-round btn-primary"/></input>
