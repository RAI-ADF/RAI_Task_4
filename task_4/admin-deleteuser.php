...
if ((isset($_POST['id'])) && ($_POST['id'] != "")) {
  ...
  $deleteGoTo = "admin-deleteuser.php";
		...
		<center>
		  <form action="" method="post" name="manageuser" id="manageuser">
            ...
            <table width="425" border="0">
              <tr>
                <th width="130" scope="row">Username :</th>
                <td width="247"><?php echo $row_manageuser['username']; ?></td>
                <td width="34"><input type="submit" name="delete" id="delete" value="X">
                <input name="id" type="hidden" id="id" value="<?php echo $row_manageuser['id']; ?>"></td>
              </tr>
            </table>
