...
mysql_select_db($database_koneksi, $koneksi);
$query_admin = "SELECT * FROM users WHERE UserLevel = 1";
...
$row_admin = mysql_fetch_assoc($admin);
$totalRows_admin = mysql_num_rows($admin);
$query_SignUp = "SELECT `username` ,  `password` ,  `fname` ,  `lname` ,  `email` ,  `dob` ,  `city`, `region`,`UserLevel`, `id` FROM `users` WHERE `UserLevel` =1";
...
<table align="center" width="325" height="310" border="0">
	    <tr>
		  ...
		  <tr>
		    <th scope="row"></th>
		    <td><input name="id" type="hidden" id="id" value="<?php echo $row_admin['id']; ?>"></td>
