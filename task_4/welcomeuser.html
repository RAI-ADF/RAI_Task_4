			...
			<style>
				.nav-pills > li > a{
					...
					<ul class="nav nav-pills nav-stacked nav-static"> <!--stacked untuk jadi vertical -->
						...
						<li><a href="lihatdata.php">Lihatdata</a></li>
					</ul>
		</div>
					...
					<div class="collapse navbar-collapse">
						<div class="row flush-col"> 
							...
							<style>
								...
								<div class="col-md-6 text-center"><li><a style="color: #c01515" href="b1-inputkasus.php"><p class="text-center"><div class="glyphicon glyphicon-pencil"></div>&nbsp;&nbsp;<div class="glyphicon glyphicon-briefcase"></div><br>Menu Utama OPAL</p></a></li></div>
