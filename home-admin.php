...
$totalRows_admin = mysql_num_rows($admin);mysql_select_db($database_koneksi, $koneksi);
$query_admin = "SELECT `id` ,  `username` ,  `password` ,  `fname` ,  `lname` ,  `email` ,  `dob` ,  `UserLevel` FROM `users` WHERE `UserLevel` =1";
$admin = mysql_query($query_admin, $koneksi) or die(mysql_error());
$row_admin = mysql_fetch_assoc($admin);
...
<div id="isi">
  	<article>
    	<h3><center>
    	  <p>&nbsp;</p>
    	  <p>WELCOME IN P's WEBSITE,   <?php echo $row_admin['username']; ?> !!!!!</p>
    	</center></h3>
		<center><p>WHATS NEW?</p><a href="#"><img src='klik.png'></a></center>
<div id="halamanbawah">
