            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <div class="navbar-brand" href="index.php">Dashboard</div>
                    </div>
                     <div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-primary">
                        ...
                        <form method="POST" action="machine/p_inputtarget.php" >
                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel">
                                <input class="form-control text-center" type="int" name="input_target" placeholder="- INSERT TARGET VALUE -" value="">
                            </div>
                                                        
                        </div>

                        <div class="panel-footer">
                            <button class="btn btn-primary" type="submit"><h6>Submit</h6></button>
                        </div>
                        </form>
                </div>
