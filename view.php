...
<table align="center" width="325" height="310" border="0">
	    <tr>
		    ...
		    <td width="21">:</td>
		    <td width="149"><?php echo $row_update['username']; ?></td>
        </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td>:</td>
		    <td><?php echo $row_update['lname']; ?></td>
	      </tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td>:</td>
		    <td><?php echo $row_update['region']; ?>, <?php echo $row_update['city']; ?></td>
	      </tr>
		  <tr>
		    <th scope="row"></th>
...
<input type="hidden" name="MM_update" value="myForm">
	...
	<script src="http://code.jquery.com/jquery-latest.min.js" type="text/javascript"></script> <script type="text/javascript" src="script/jquery-1.8.2.min.js"></script>
